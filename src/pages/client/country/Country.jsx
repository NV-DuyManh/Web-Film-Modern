...
function Country({ openCountry }) {
    return (
        <div 
            className={`absolute top-full mt-3 right-0 lg:-right-10 z-50 w-145 rounded-2xl bg-black/80 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_0_0_1px_rgba(255,255,255,0.05)] transition-all duration-300 origin-top-right ${openCountry ? "opacity-100 visible translate-y-0 scale-100" : "opacity-0 invisible -translate-y-2 scale-95"}`}
