            ...
            <div className="relative rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(145deg, #1a2035, #0f1322)' }}>
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-8 py-10 gap-5">
                    ...
                    <div className="flex gap-3 w-full mt-2">
                        <button
                            onClick={handleClose}
                            className="flex-1 px-5 py-2.5 rounded-full font-bold text-sm text-slate-300 bg-slate-700/50 border border-slate-600/50 hover:bg-slate-600/50 hover:text-white transition-all cursor-pointer"
                        >
                            Để sau
                        </button>
                        <button
                            ...
                            className="flex-1 px-5 py-2.5 rounded-full font-bold text-sm text-black bg-yellow-400 hover:bg-yellow-500 shadow-[0_0_15px_rgba(250,204,21,0.3)] hover:shadow-[0_0_20px_rgba(250,204,21,0.5)] transition-all cursor-pointer"
                        >
                            🔑 Đăng nhập ngay
                        </button>
                    </div>
