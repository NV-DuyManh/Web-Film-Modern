                    ...
                    {filteredMovies.length > 0 ? filteredMovies.map(movie => (
                        viewMode === 'grid' ? (
                            <Link to={`/phim/${movie.slug || movie.id}`} key={`grid-${movie.id}`} className="group relative flex flex-col gap-3 cursor-pointer">
                                <div className="relative rounded-2xl overflow-hidden border-3 border-transparent bg-slate-800/40 hover:border-fuchsia-400 transition duration-300 hover:shadow-[0_12px_25px_rgba(232,121,249,0.3)] hover:-translate-y-2 aspect-2/3 w-full">
                            ...
                            <div key={`list-${movie.id}`} className="flex flex-col sm:flex-row items-center gap-4 p-3 rounded-2xl border border-white/10 bg-slate-800/50 backdrop-blur-md hover:border-fuchsia-500/40 hover:shadow-[0_0_25px_rgba(232,121,249,0.2)] transition duration-300 group">
                                <Link to={`/phim/${movie.slug || movie.id}`} className="w-32 sm:w-40 md:w-48 h-auto aspect-video rounded-xl overflow-hidden shrink-0 border-3 border-transparent group-hover:border-fuchsia-400 transition duration-300 relative block">
