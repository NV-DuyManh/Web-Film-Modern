...
function ContinueFilm(props) {
    ...
    return (
        <div className="w-full flex flex-col gap-6 p-6 bg-[#1e293b]/60 rounded-2xl border border-yellow-500/50 shadow-[0_0_15px_rgba(234,179,8,0.15)] min-h-full">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full mb-2">
                    ...
                    <div className="flex flex-row items-center justify-between sm:justify-end gap-3 w-full md:w-auto shrink-0">
                        <div className="premium-border-box flex flex-1 sm:flex-none justify-center items-center gap-3 px-4 py-2 bg-slate-800/50 backdrop-blur-md rounded-xl shadow-lg whitespace-nowrap group h-10.5">
                            ...
                            <div className="flex items-center justify-center bg-blue-500/10 border border-blue-500/20 px-3 py-0.5 rounded-lg group-hover:bg-blue-500/20 group-hover:border-blue-500/40 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition duration-300">
                        ...
                        <div className="flex items-center bg-slate-800/80 p-1.5 rounded-xl border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.5)] backdrop-blur-md shrink-0 h-10.5">
                            <button
                                ...
                                className={`p-1.5 sm:p-2 rounded-lg transition duration-300 flex items-center justify-center ${viewMode === 'grid' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.3)] scale-105' : 'text-slate-400 hover:text-white hover:bg-white/5 border border-transparent'}`}
                            >
                                <FaTh size={18} />
                            </button>
                            <button
                                onClick={() => setViewMode('list')}
                                className={`p-1.5 sm:p-2 rounded-lg transition duration-300 flex items-center justify-center ${viewMode === 'list' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.3)] scale-105' : 'text-slate-400 hover:text-white hover:bg-white/5 border border-transparent'}`}
                            >
                                <FaList size={18} />
                            </button>
                        </div>
            ...
            {continueMovies.length === 0 ? (
                <div className="mt-4 w-full min-h-87.5 border border-white/5 rounded-3xl bg-[#15171a]/40 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center relative overflow-hidden shadow-inner">
                    ...
                    {filteredMovies.length > 0 ? filteredMovies.map(movie => (
                        viewMode === 'grid' ? (
                            <Link to={`/phim/${movie.slug || movie.id}`} key={`grid-${movie.id}`} className="group relative flex flex-col gap-3 cursor-pointer">
                                <div className="relative rounded-2xl overflow-hidden border-[3px] border-transparent bg-slate-800/40 hover:border-blue-400 transition duration-300 hover:shadow-[0_12px_25px_rgba(59,130,246,0.3)] hover:-translate-y-2 aspect-2/3 w-full">
                                    ...
                                    <div className="absolute bottom-3 left-3 bg-slate-900/80 backdrop-blur-md px-3 py-1.5 rounded-full shadow-[0_4px_15px_rgba(0,0,0,0.8)] border border-blue-500/50 group-hover:border-blue-400 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.5)] transition duration-300 flex items-center gap-1.5">
                                ...
                                <div className="px-1 mt-2 mb-1 flex flex-col items-center">
                                    <h3 className="text-white font-bold text-sm md:text-base text-center line-clamp-1 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] group-hover:text-blue-400 group-hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] transition duration-300">
                                        {movie.otherName}
                                    </h3>
                            ...
                            <div key={`list-${movie.id}`} className="flex flex-col sm:flex-row items-center gap-4 p-3 rounded-2xl border border-white/10 bg-slate-800/50 backdrop-blur-md hover:border-blue-500/40 hover:shadow-[0_0_25px_rgba(59,130,246,0.2)] transition duration-300 group">
                                <Link to={`/phim/${movie.slug || movie.id}`} className="w-32 sm:w-40 md:w-48 h-auto aspect-video rounded-xl overflow-hidden shrink-0 border-[3px] border-transparent group-hover:border-blue-400 transition duration-300 relative block">
