    ...
    return (
        <div>
            ...
            <div className="rounded-xl bg-[#182233] py-2 overflow-hidden divide-y divide-white/5">
                <FilmCountry title={<>Phim Nhật <br className="hidden md:block"/>Bản mới</>} countryName="Japan" titleClass="glow-text-[4px]" />
                <FilmCountry title={<>Phim Trung <br className="hidden md:block"/>Quốc mới</>} countryName="China" titleClass="glow-text-[8px]" />
                <FilmCountry title={<>Phim Hàn <br className="hidden md:block"/>Quốc mới</>} countryName="South Korea" titleClass="glow-text-[12px]" />
            </div>
            </div>
            </div>
            <TopFilm />
