...
function FilmNewPage() {
    ...
    const totalPages = Math.ceil(newMovies.length / moviesPerPage) || 1;
    const safePage = Math.min(page, totalPages);
    const currentMovies = newMovies.slice((safePage - 1) * moviesPerPage, safePage * moviesPerPage);
