                    ...
                    <div className="relative bg-white/2 p-5 rounded-2xl border border-emerald-500/20 space-y-4 overflow-hidden shadow-[0_0_15px_rgba(16,185,129,0.05)]">
                            ...
                            {movie.listCategory?.map((item) => {
                                ...
                                return category ? (
                                    <div key={item} className="relative inline-block mt-2 mr-1 group">
                                        ...
                                        <FaTimesCircle onClick={() => handleRemoveItem("categories", item)} className="absolute -top-1.5 -right-1.5 text-rose-500 bg-white rounded-full text-sm cursor-pointer hover:text-white hover:bg-rose-500 hover:scale-125 hover:rotate-90 transition-all duration-300 z-10 shadow-sm" />
                                    </div>
                                ) : null;
                            })}
                        </div>
                            ...
                            {movie.listAuthor?.map((item) => {
                                ...
                                return author ? (
                                    <div key={item} className="relative inline-block mt-1 mr-1 group cursor-pointer mb-2">
                                        <img className='w-11 h-11 rounded-full object-cover shadow-[0_0_10px_rgba(250,204,21,0.5)] border border-yellow-500/30 group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(250,204,21,0.8)] transition-all duration-300' src={getSafeEntityAvatar(author.imgUrl, author.sexID)} alt={author.name} onError={(e) => { e.target.onerror = null; e.target.src = getDefaultAvatar(author.sexID); }} />
                                        <FaTimesCircle onClick={() => handleRemoveItem("authors", item)} className="absolute top-0 right-0 text-rose-500 bg-white rounded-full text-sm cursor-pointer hover:text-white hover:bg-rose-500 hover:scale-125 hover:rotate-90 transition-all duration-300 z-10 shadow-sm" />
                        ...
                        <div className='text-white flex gap-2 flex-wrap'>
                            {movie.listActor?.map((item) => {
                                ...
                                return actor ? (
                                    <div key={item} className="relative inline-block mt-1 mr-1 group cursor-pointer mb-2">
                                        <img className='w-11 h-11 rounded-full object-cover shadow-[0_0_10px_rgba(236,72,153,0.5)] border border-pink-500/30 group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(236,72,153,0.8)] transition-all duration-300' src={getSafeEntityAvatar(actor.imgUrl, actor.sexID)} alt={actor.name} onError={(e) => { e.target.onerror = null; e.target.src = getDefaultAvatar(actor.sexID); }} />
                                        <FaTimesCircle onClick={() => handleRemoveItem("actors", item)} className="absolute top-0 right-0 text-rose-500 bg-white rounded-full text-sm cursor-pointer hover:text-white hover:bg-rose-500 hover:scale-125 hover:rotate-90 transition-all duration-300 z-10 shadow-sm" />
                        ...
                        <div className='text-white flex gap-2 flex-wrap'>
                            {movie.listCharacter?.map((item) => {
                                ...
                                return character ? (
                                    <div key={item} className="relative inline-block mt-1 mr-1 group cursor-pointer mb-2">
                                        <img className='w-11 h-11 rounded-full object-cover shadow-[0_0_10px_rgba(74,222,128,0.5)] border border-green-500/30 group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(74,222,128,0.8)] transition-all duration-300' src={getSafeEntityAvatar(character.imgUrl, character.sexID)} alt={character.name} onError={(e) => { e.target.onerror = null; e.target.src = getDefaultAvatar(character.sexID); }} />
                                        <FaTimesCircle onClick={() => handleRemoveItem("characters", item)} className="absolute top-0 right-0 text-rose-500 bg-white rounded-full text-sm cursor-pointer hover:text-white hover:bg-rose-500 hover:scale-125 hover:rotate-90 transition-all duration-300 z-10 shadow-sm" />
                        ...
                        <div className="flex gap-4">
                            <div className="flex flex-col items-center w-1/3">
                                ...
                                <div className="flex bg-slate-900/80 rounded-lg p-0.5 mb-2 w-full border border-white/10">
                                    <button type="button" onClick={() => setPosterMode('file')} className={`flex-1 flex items-center justify-center gap-1 py-1 rounded-md text-[10px] font-bold transition-all duration-300 ${posterMode === 'file' ? 'bg-linear-to-r from-pink-500 to-fuchsia-500 text-white shadow-[0_0_12px_rgba(236,72,153,0.4)]' : 'text-gray-400 hover:text-white'}`}>
                                        <FaCloudUploadAlt className="text-xs" /> File
                                    </button>
                                    <button type="button" onClick={() => setPosterMode('url')} className={`flex-1 flex items-center justify-center gap-1 py-1 rounded-md text-[10px] font-bold transition-all duration-300 ${posterMode === 'url' ? 'bg-linear-to-r from-cyan-500 to-blue-500 text-white shadow-[0_0_12px_rgba(6,182,212,0.4)]' : 'text-gray-400 hover:text-white'}`}>
                            ...
                            <div className="flex flex-col items-center w-2/3">
                                ...
                                <div className="flex bg-slate-900/80 rounded-lg p-0.5 mb-2 w-full border border-white/10">
                                    <button type="button" onClick={() => setBannerMode('file')} className={`flex-1 flex items-center justify-center gap-1 py-1 rounded-md text-[10px] font-bold transition-all duration-300 ${bannerMode === 'file' ? 'bg-linear-to-r from-yellow-500 to-orange-500 text-white shadow-[0_0_12px_rgba(234,179,8,0.4)]' : 'text-gray-400 hover:text-white'}`}>
                                        <FaCloudUploadAlt className="text-xs" /> File
                                    </button>
                                    <button type="button" onClick={() => setBannerMode('url')} className={`flex-1 flex items-center justify-center gap-1 py-1 rounded-md text-[10px] font-bold transition-all duration-300 ${bannerMode === 'url' ? 'bg-linear-to-r from-cyan-500 to-blue-500 text-white shadow-[0_0_12px_rgba(6,182,212,0.4)]' : 'text-gray-400 hover:text-white'}`}>
                                        <FaLink className="text-xs" /> URL
                                    </button>
                                </div>
                                {bannerMode === 'file' ? (
