...
export default function ModalAuthors({ open, onChangeInput, handleClose, addauthor, error, loading, progress, author, handleImageChange, setAuthor }) {
                        ...
                        {uploadMode === 'file' ? (
                            ...
                            <div className="w-full flex flex-col gap-4 items-center">
                                ...
                                <div className="w-36 h-36 rounded-full overflow-hidden border border-white/10 bg-slate-900/50 flex items-center justify-center">
                                    {author.imgUrl?.startsWith('http') ? (
                                        <img src={author.imgUrl} className="w-full h-full object-cover" alt="Preview" onError={(e) => e.target.src = LOGO} />
                                    ) : (
