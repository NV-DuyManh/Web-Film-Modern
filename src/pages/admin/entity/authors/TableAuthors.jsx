...
function TableAuthors({ handleClickOpen, setAuthor, author }) {
    ...
    const currentData = authors?.slice(start, start + rowsPerPage) || [];
                        ...
                        <tbody>
                            {currentData.map((row, index) => (
                                <tr key={index} className="table-row">
                                    ...
                                    <td className="table-cell">{row.sexID}</td>
                                    <td className="table-cell">{row.countriesID}</td>
