...
import { FaCloudUploadAlt, FaExchangeAlt, FaLink } from 'react-icons/fa';
...
export default function ModalActor({ open, onChangeInput, handleClose, addactor, error, loading, progress, actor, handleImageChange, setActor }) {
                        ...
                        {uploadMode === 'file' ? (
                            ...
                            <div className="w-full flex flex-col gap-4 items-center">
                                ...
                                <div className="w-36 h-36 rounded-full overflow-hidden border border-white/10 bg-slate-900/50 flex items-center justify-center">
                                    {actor.imgUrl?.startsWith('http') ? (
                                        <img src={actor.imgUrl} className="w-full h-full object-cover" alt="Preview" onError={(e) => e.target.src = LOGO} />
                                    ) : (
