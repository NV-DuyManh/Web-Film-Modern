                    ...
                    return (
                        <li key={index} className='flex flex-col relative group'>
                            ...
                            >
                                ...
                                <p className={`text-lg transition-transform duration-300 shrink-0 ${isOpen ? "rotate-180" : "rotate-0"} ${isParentActive ? "text-cyan-400" : "text-gray-400"} ${Menu ? "max-sm:block sm:hidden" : "block"}`}>
