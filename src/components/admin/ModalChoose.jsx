                    ...
                    {dataChoose?.map((item) => {
                        ...
                        return type === "categoryTypes" || type === "categories" ? (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl border transition-all font-bold tracking-wide shadow-md ${isSelected
                            ...
                            <div
                                key={item.id}
                                onClick={() => handleClickChoose(item.id)}
                                className={`cursor-pointer flex flex-col items-center gap-2 transition-transform ${isSelected
                                        ? "scale-110"
                                        : "hover:scale-110 opacity-70 hover:opacity-100"
                                    }`}
                            >
                                <img
                                    className={`w-16 h-16 rounded-full object-cover transition-all ${isSelected
