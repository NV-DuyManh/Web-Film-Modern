...
function FooterClient() {
    return (
        <footer className='relative overflow-hidden bg-[#03040a] px-6 py-12 text-white md:px-12 lg:px-20'>
            ...
            <div className='relative mx-auto flex max-w-362.5 flex-col gap-12 lg:flex-row lg:items-start lg:justify-between'>
                <div className='max-w-205'>
                    ...
                    <div className='flex flex-col items-center gap-6 text-center md:flex-row md:items-center md:text-left'>
                        ...
                        <div className='flex items-center justify-center gap-4 md:ml-2'>
                            <a href="" target="_blank" className='flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/8 text-lg text-white/80 transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:text-black hover:shadow-[0_0_20px_rgba(255,255,255,0.25)]'><FaXTwitter /></a>
                    ...
                    <div className='mt-8 flex flex-wrap gap-x-10 gap-y-4 text-base font-semibold text-white'>
                    ...
                    <div className='mt-6 max-w-195 text-[15px] leading-7 text-gray-300'>
                        <p>
                ...
                <div className='flex w-full justify-center lg:w-140 lg:justify-end'>
                    <div className='w-full max-w-140 rounded-3xl border border-white/10 bg-white/3 p-7 text-center shadow-[0_20px_70px_rgba(0,0,0,0.35)] backdrop-blur-sm'>
                        ...
                        <div className='mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row'>
                            ...
                            <a href="" className='flex h-15 w-full items-center justify-center gap-3 rounded-xl border border-white/50 bg-black px-5 text-white transition-all duration-300 hover:-translate-y-1 hover:border-white hover:shadow-[0_0_24px_rgba255,255,255,0.22)] sm:w-56'>
